...
using SoftwareTestProject.Components;
using SoftwareTestProject.Components.Account;
...
using (StreamWriter outputFile = new StreamWriter("testtxtfile.txt"))
{
        outputFile.WriteLine("this is a test to create a txt file");
}
